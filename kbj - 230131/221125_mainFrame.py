...
class FRAArrayFrame(Frame):
    def __init__(self, master):
        ...
        self.row_file_array_frame = Frame(self.array_file_edit_lf)
        self.row_file_array_frame.pack()

        self.row_array_from_label = Label(self.row_file_array_frame, text="Row : From")
        self.row_array_from_label.pack(side="left")

        self.row_array_from_entry = Entry(
            self.row_file_array_frame,
            fg="black",
            justify=CENTER,
            font=("Arial", 10),
        )
        self.row_array_from_entry.pack(side="left")
        self.row_array_from_entry.insert(index=END, string="0")

        self.row_array_to_label = Label(self.row_file_array_frame, text="to")
        self.row_array_to_label.pack(side="left")

        self.row_array_to_entry = Entry(
            self.row_file_array_frame,
            fg="black",
            justify=CENTER,
            font=("Arial", 10),
        )
        self.row_array_to_entry.pack(side="left")
        self.row_array_to_entry.insert(index=END, string="301")

        self.column_file_array_frame = Frame(self.array_file_edit_lf)
        self.column_file_array_frame.pack()

        self.column_array_from_label = Label(self.column_file_array_frame, text="Column : From")
        self.column_array_from_label.pack(side="left")

        self.column_array_from_entry = Entry(
            self.column_file_array_frame,
            fg="black",
            justify=CENTER,
            font=("Arial", 10),
        )
        self.column_array_from_entry.pack(side="left")
        self.column_array_from_entry.insert(index=END, string="1")

        self.column_array_to_label = Label(self.column_file_array_frame, text="to")
        self.column_array_to_label.pack(side="left")

        self.column_array_to_entry = Entry(
            self.column_file_array_frame,
            fg="black",
            justify=CENTER,
            font=("Arial", 10),
        )
        self.column_array_to_entry.pack(side="left")
        self.column_array_to_entry.insert(index=END, string="2")
    ...
    def file_format_set_button(self):
        ...
        self.row_array_from_entry.delete(0, "end")
        self.row_array_to_entry.delete(0, "end")
        self.column_array_from_entry.delete(0, "end")
        self.column_array_to_entry.delete(0, "end")
        ...
        if file_format == "AKM FRA":
            ...
            self.row_array_from_entry.insert(index=END, string="19")
            self.row_array_to_entry.insert(index=END, string="419")
            self.column_array_from_entry.insert(index=END, string="1")
            self.column_array_to_entry.insert(index=END, string="4")
        elif file_format == "AKM Ringing":
            self.row_array_from_entry.insert(index=END, string="20")
            self.row_array_to_entry.insert(index=END, string="172")
            self.column_array_from_entry.insert(index=END, string="1")
            self.column_array_to_entry.insert(index=END, string="4")
            ...
            self.row_array_from_entry.insert(index=END, string="0")
            self.row_array_to_entry.insert(index=END, string="31")
            self.column_array_from_entry.insert(index=END, string="1")
            self.column_array_to_entry.insert(index=END, string="4")
    ...
    def start_button(self):
        ...
        if self.row_array_from_entry.get() > self.row_array_to_entry.get():
            self.display_lb["text"] = "From 보다 to의 값이 큽니다."
            return
        elif self.column_array_from_entry.get() > self.column_array_to_entry.get():
            self.display_lb["text"] = "From 보다 to의 값이 큽니다."
            return
        ...
        fra_array = mf.FRAArray(
            ...
            row_array_from=int(self.row_array_from_entry.get()),
            row_array_to=int(self.row_array_to_entry.get()),
            column_array_from=int(self.column_array_from_entry.get()),
            column_array_to=int(self.column_array_to_entry.get()),
        )
        ...
        elif fra_array_result == -3:
            self.display_lb["text"] = "정렬 파일 편집의 Row/ Column 범위를 다시 설정해주세요"
...
"""
    def start_button(self):
        ...
        fra_array = mf.FRAArray(
            ...
            _file_name=self.file_name_entry.get(),
            _array_from=int(self.row_array_from_entry.get()),
            _array_to=int(self.row_array_to_entry.get()),
        )
        fra_array_result = fra_array.fra_array_start()
